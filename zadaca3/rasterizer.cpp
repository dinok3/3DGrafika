...
int main()
{
    ...
    // zad1
    draw_triangle_2d(500, 450, 300, 350,150,450,image,red);
    draw_triangle_2d(500, 350, 300, 300,150,400,image,white);
    //zad2
    draw_triangle_gouraud(10, 30, 50, 350,200,300,image,blue,red,white);
    //zad3
